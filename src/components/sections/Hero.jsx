...
const SLIDES = [tunnelImage, hydroImage, roadImage, surveyImage]
...
export default function Hero() {
  ...
  const index = useHeroSlides(inView)
  ...
  return (
    ...
    >
      ...
      <div className="relative flex w-full flex-1 flex-col items-center justify-center px-5 py-28 text-center sm:px-8 lg:px-16 lg:py-32">
